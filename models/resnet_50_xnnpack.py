...
def ResNet50XNNPACK(include_top=True,
             weights='imagenet',
             input_tensor=None,
             input_shape=None,
             pooling=None,
...
def ResNet101XNNPACK(include_top=True,
              weights='imagenet',
              input_tensor=None,
              input_shape=None,
              pooling=None,
...
def ResNet152XNNPACK(include_top=True,
              weights='imagenet',
              input_tensor=None,
              input_shape=None,
              pooling=None,
...
setattr(ResNet50XNNPACK, '__doc__', ResNet50XNNPACK.__doc__ + DOC)
setattr(ResNet101XNNPACK, '__doc__', ResNet101XNNPACK.__doc__ + DOC)
setattr(ResNet152XNNPACK, '__doc__', ResNet152XNNPACK.__doc__ + DOC)
